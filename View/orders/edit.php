                        ...
                        <div class="row">
                                <div class="col-md-12" >
                                    ...
                                    <textarea id="PaymentNote" name="PaymentNote" class="form-control"
                                        placeholder="Opcional information" rows="5"><?= $Payment->PaymentNote; ?></textarea>
                                </div>
                                <!-- end row -->
                            </div>
                        </div>
...
$("#form-horizontal").steps({
    ...
    onStepChanging: function (event, currentIndex, newIndex)
    {
        ...
        switch (newIndex) {
            ...
            onInit: function() {},
            labels: { cancel: "Cancel", current: "current step:", pagination: "Pagination", finish: "Update order", next: "Next Step", previous: "Previous Step", loading: "Loading ..." }, 
