...
class OrderDetails {
    ...
    public function View()
    {
        ...
        {
            die("View OrderDetails: ".$e->getMessage());
        }
    }
    ...
    public function Edit($id)
    {
        ...
        {
            die("Edit OrderDetails: ".$e->getMessage());
        }
    }
...
$result=  $this->pdo->prepare($sql)
        ...
        {
            die("Update OrderDetails:".$e->getMessage());
        }
    }
    ...
    public function Create (OrderDetails $data)
    {
        ...
        {
            die("Create OrderDetails: ".$e->getMessage());
        }
    }
    ...
    public function DeleteOrderDetail($OrderDetailsID)
    {
        ...
        {
            die("DeleteOrderDetail: ".$e->getMessage());
        }
    }
